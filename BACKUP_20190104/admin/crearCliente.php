    ...
    <div class="page">
      ...
      <div class="breadcrumb-holder">
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="adminCliente.php">Administrar Clientes</a></li>
      ...
      <section>
        <div class="container-fluid">
          <!-- Page Header-->
          <header>
            <h1 class="h3 display">Crear Cliente</h1>
          </header>

          <!-- INICIO DE FORMULARIO DE CREACION DE EQUIPO -->
					<form name="formCrearCliente" method="post" enctype="multipart/form-data" action="action_crearCliente.php">
          
            <label for="exampleInputName">COID</label>
					  <input class="form-control" id="coid" name="coid" type="text" aria-describedby="nameHelp" placeholder="Ingrese COID">
					  <br>

					 <label for="exampleInputName">RUT</label>
					 <input class="form-control" id="rut" name="rut" type="text" aria-describedby="nameHelp" placeholder="Ingrese RUT">
					 <br>
           ...
           <label for="exampleInputName">Clave</label>
					 <input class="form-control" id="clave" name="clave" type="text" aria-describedby="nameHelp" placeholder="Ingrese Clave">
					 <br>

           <label for="exampleInputName">Maquina</label>
					 <input class="form-control" id="maquina" name="maquina" type="text" aria-describedby="nameHelp" placeholder="Ingrese Maquina">
					 <br>

           <label for="exampleInputName">URL</label>
					 <input class="form-control" id="url" name="url" type="text" aria-describedby="nameHelp" placeholder="Ingrese URL">
					 <br>
